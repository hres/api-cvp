...
var cvp = "./Controllers/dhprController.ashx?";
...
function goCvpUrl(lang) {
    ...
    var sourceOfReport = getParameterByName("sourceOfReport");
    var reportOutcome = getParameterByName("reportOutcome");
    var searchUrl = dhpr + "term=" + term + "&ageRange=" + ageRange + "&gender=" + gender +
        "&seriousReport=" + seriousReport + "&sourceOfReport=" + sourceOfReport + "&reportOutcome=" + reportOutcome +
        "&startDate=" + startDate + "&endDate=" + endDate + "&lang=" + lang;
    return searchUrl;
}
...
function goCvpUrlByID(lang) {
    ...
    var searchUrl = cvp + "linkID=" + linkID + "&lang=" + lang;
    return searchUrl;
}

function goCvpReportDrugUrlByID(lang) {
    var linkID = getParameterByName("linkID");
    var searchUrl = cvp + "drugsReportId=" + linkID + "&lang=" + lang;
    return searchUrl;
}

function goCvpReactionsUrlByID(lang) {
    var linkID = getParameterByName("linkID");
    var searchUrl = cvp + "reactionsReportId=" + linkID + "&lang=" + lang;
    return searchUrl;
}
...
function goDhprLangUrlByID(lang, pType) {
    var linkID = getParameterByName("linkID");
    var langSwitch = lang == 'en' ? "fr" : "en";
    var langUrl = "canada-vigilance-result.html?" + langSwitch + ".html?linkID=" + linkID + "&pType=" + pType + "&lang=" + langSwitch;
    return langUrl;
}
